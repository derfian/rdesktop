...
/* TS_SHARECONTROLHEADER pduType codes */
enum RDP_PDU_TYPE
{
	PDUTYPE_DEMANDACTIVEPDU	 = 1,
	PDUTYPE_CONFIRMACTIVEPDU = 3,
	PDUTYPE_DEACTIVATEALLPDU = 6,
	RDP_PDU_REDIRECT	 = 4,	/* Standard Server Redirect (obsolete?) */
	PDUTYPE_DATAPDU		 = 7,
	PDUTYPE_SERVER_REDIR_PKT = 10	/* Enhanced Server Redirect */
};

/* [MS-RDPBCGR] TS_SHARECONTROLHEADER pduType */
#define TS_PROTOCOL_VERSION	1

/* [MS-RDPBCGR] TS_SHAREDATAHEADER streamId */
#define STREAM_UNDEFINED	0x00
#define STREAM_LOW		0x01
#define STREAM_MED		0x02
#define STREAM_HI		0x04

/* [MS-RDPBCGR] TS_SHAREDATAHEADER pduType2 */
